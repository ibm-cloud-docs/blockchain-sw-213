...
<div style="background-color: #6fdc8c; padding-left: 20px; padding-right: 20px; border-bottom: 4px solid #0f62fe; padding-top: 12px; padding-bottom: 4px; margin-bottom: 16px;">
  <p style="line-height: 20px;">
    ...
    2.1.3, <a href="/docs/blockchain-sw-25?topic=blockchain-sw-25-ansible-build">2.5</a>,
    <a href="/docs/blockchain-sw-251?topic=blockchain-sw-251-ansible-build">2.5.1</a>,
    <a href="/docs/blockchain-sw-252?topic=blockchain-sw-252-ansible-build">2.5.2 (latest)</a>
    </p>
</div>
...
2. (Optional) Get an API `key` and `secret` that you can use to access your {{site.data.keyword.blockchainfull_notm}} Platform console. If you want to skip getting an API key and secret, you can also just use your console **username** and **password** instead of an API key and secret, although that would not be recommended in a production setting.
 ...
 If you prefer to use an API `key` and `secret`, then you need to use the [{{site.data.keyword.blockchainfull_notm}} Platform REST APIs](/docs/blockchain-sw-213?topic=blockchain-sw-213-ibp-v2-apis#console-icp-manage-api-key) to generate them. Save the value of the `"api_key"` and `"api_secret"` to be used in step three.
