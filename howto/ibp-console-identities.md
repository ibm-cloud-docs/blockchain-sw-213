...
For more information about how to deploy the HSM proxy and use HSM with a CA, peer, or ordering node see [Setting up a PKCS11 proxy for HSM](/docs/blockchain-sw-213?topic=blockchain-sw-213-ibp-console-adv-deployment#ibp-console-adv-deployment-pkcs11-proxy) and [Configuring a node to use HSM](/docs/blockchain-sw-213?topic=blockchain-sw-213-ibp-console-adv-deployment#ibp-console-adv-deployment-cfg-hsm)
