...
<div style="background-color: #6fdc8c; padding-left: 20px; padding-right: 20px; border-bottom: 4px solid #0f62fe; padding-top: 12px; padding-bottom: 4px; margin-bottom: 16px;">
  <p style="line-height: 20px;">
    ...
    <a href="https://cloud.ibm.com/docs/blockchain-sw-25?topic=blockchain-sw-25-console-icp-manage">2.5 (latest)</a>
    </p>
</div>
...
Updates are applied to nodes one at a time. While the update is being applied, the node is unavailable to process requests or transactions. Therefore, to avoid any disruption of service, whenever possible you should ensure another node of the same type is available to process requests. Installing updates on a node takes about a minute to complete and when the update is complete, the node is ready to process requests.
{:note}

To update a node, open the node tile and click the **Update available** button.

You cannot update nodes that you imported to the console.
{: important}
