...
<div style="background-color: #6fdc8c; padding-left: 20px; padding-right: 20px; border-bottom: 4px solid #0f62fe; padding-top: 12px; padding-bottom: 4px; margin-bottom: 16px;">
  <p style="line-height: 20px;">
    ...
    <a href="https://cloud.ibm.com/docs/blockchain-sw-25?topic=blockchain-sw-25-release-notes-saas-20">2.5 (latest)</a>
    </p>
</div>
...
See [Installing patches](/docs/blockchain-sw-213?topic=blockchain-sw-213-console-icp-manage#ibp-console-manage-patch) for instructions on how to update your existing nodes.
