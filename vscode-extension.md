...
<caption>Deployment options</caption>
  ...
  <tbody>
    ...
    <td><ul>
    <li>[Red Hat Code Ready workspaces](/docs/blockchain-sw-213?topic=blockchain-sw-213-develop-vscode#develop-vscode-crw)</li>
    </li>
    </ul></td>
     </tr>
     <tr>
     ...
     <td><ul>
    <li>[Deploy VSCode locally from Visual Studio Marketplace](/docs/blockchain-sw-213?topic=blockchain-sw-213-develop-vscode#develop-vscode-install)</li>
     </ul></td>
      </tr>
  </tbody>
</table>
