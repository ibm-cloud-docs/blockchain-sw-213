...
- **Maintain complete control of your identities**. Store and manage the keys that are used to administer your nodes locally.
...
- **Direct access to the logs** of your nodes from your the  Kubernetes service. Use  any supported third-party service to extract and analyze your logs.
- **Interact directly with your pods** using <blockchain-sw-w213>your Kubernetes service .
- **Dynamic signature collection** that allows better control over collaborative governance over channel configurations.
- **Kubernetes service integration.** Leverage services such as LogDNA for logging and and Prometheus and Sysdig for monitoring.
